        ...
        <Layout>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm flex items-center space-x-4">
                    ...
                    <div>
                        <p className="text-xs font-bold text-secondary-400 uppercase tracking-wider">Total Staff</p>
                ...
                <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm flex items-center space-x-4">
                    ...
                    <div>
                        <p className="text-xs font-bold text-secondary-400 uppercase tracking-wider">Monthly Payroll</p>
                        <h3 className="text-2xl font-black text-secondary-900">{payrolls.filter(p => p.month === 'January').length} Paid</h3>
                    </div>
                </div>
                <div className="bg-secondary-950 p-6 rounded-3xl flex items-center space-x-4 shadow-xl">
                    ...
                    <div>
                        <p className="text-xs font-bold text-secondary-400 uppercase tracking-wider">Total Wage Bill</p>
            ...
            <div className="bg-white rounded-[2rem] border border-slate-100 shadow-sm overflow-hidden min-h-[500px]">
                <div className="flex border-b border-slate-100">
                    ...
                    <button
                        ...
                        className={`px-8 py-4 font-bold text-sm transition-all ${activeTab === 'payroll' ? 'bg-primary-50 text-primary-600 border-b-2 border-primary-600' : 'text-secondary-400 hover:bg-slate-50'}`}
                    >
                        Payroll History
                    </button>
                </div>
                            ...
                            {employees.map(emp => (
                                <div key={emp._id} className="p-6 bg-slate-50 rounded-3xl border border-slate-100 group hover:border-primary-200 transition-all">
                                    ...
                                    <div className="space-y-2 mb-6">
                                        <p className="text-xs text-secondary-400 font-bold flex items-center"><Clock size={12} className="mr-2" /> ID: {emp.employeeId}</p>
                                        <p className="text-xs text-secondary-400 font-bold flex items-center"><IndianRupee size={12} className="mr-2" /> Base: ₹{emp.salary.toLocaleString()}</p>
                                    </div>
                                    <button className="w-full py-2 bg-white border border-slate-200 rounded-xl text-xs font-bold text-slate-600 hover:bg-secondary-950 hover:text-white transition-all">View Details</button>
                                </div>
                            ))}
                        </div>
                    ) : (
                                    ...
                                    {payrolls.map(pay => (
                                        <tr key={pay._id} className="hover:bg-slate-50/50 transition-colors">
                                            <td className="px-6 py-4">
                                                <p className="font-bold text-secondary-800">{pay.employee?.name}</p>
                                                <p className="text-xs text-secondary-400 font-mono">{pay.employee?.employeeId}</p>
                                            </td>
                                            <td className="px-6 py-4">
                                            ...
                                            <td className="px-6 py-4 text-right">
                                                <div className="flex items-center justify-end space-x-2">
                                                    <span className="font-black text-secondary-900">₹{pay.netSalary.toFixed(2)}</span>
            ...
            {showModal && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    ...
                    <div className="relative bg-white w-full max-w-lg rounded-[2.5rem] shadow-2xl p-8 animate-in fade-in zoom-in duration-200">
                        <h3 className="text-2xl font-black text-secondary-900 mb-6">{activeTab === 'employees' ? 'Register New Workforce' : 'Run Payroll Disbursement'}</h3>

                        {activeTab === 'employees' ? (
                            <form onSubmit={handleEmployeeSubmit} className="space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <label className="block text-xs font-black text-secondary-400 uppercase mb-2">Staff ID</label>
                                    ...
                                    <div>
                                        <label className="block text-xs font-black text-secondary-400 uppercase mb-2">Base Salary</label>
                                ...
                                <div>
                                    <label className="block text-xs font-black text-secondary-400 uppercase mb-2">Full Name</label>
                                ...
                                <div>
                                    <label className="block text-xs font-black text-secondary-400 uppercase mb-2">Designation</label>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <label className="block text-xs font-black text-secondary-400 uppercase mb-2">Email</label>
                                    ...
                                    <div>
                                        <label className="block text-xs font-black text-secondary-400 uppercase mb-2">Phone</label>
                            ...
                            <form onSubmit={handlePayrollSubmit} className="space-y-4">
                                <div>
                                    <label className="block text-xs font-black text-secondary-400 uppercase mb-2">Select Staff</label>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <label className="block text-xs font-black text-secondary-400 uppercase mb-2">Period Month</label>
                                    ...
                                    <div>
                                        <label className="block text-xs font-black text-secondary-400 uppercase mb-2">Year</label>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <label className="block text-xs font-black text-secondary-400 uppercase mb-2">Allowance (+)</label>
                                    ...
                                    <div>
                                        <label className="block text-xs font-black text-secondary-400 uppercase mb-2">Deduction (-)</label>
