                ...
                <div className="text-center mb-16 py-10">
                    ...
                    <div className="relative max-w-2xl mx-auto group">
                        ...
                        <input 
                            ...
                            className="w-full bg-white border-2 border-slate-100 rounded-[2.5rem] pl-16 pr-8 py-6 text-lg font-bold outline-none shadow-2xl shadow-slate-900/5 focus:border-emerald-500 transition-all"
                        />
                    </div>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                    <div className="bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-xl shadow-slate-900/5 hover:border-emerald-500/20 transition-all group">
                ...
                <div className="py-20">
                    ...
                    <div className="space-y-4">
                        {[
                            ...
                            <div key={i} className="bg-white p-8 rounded-3xl border border-slate-50 hover:border-emerald-500/10 transition-all cursor-pointer group">
