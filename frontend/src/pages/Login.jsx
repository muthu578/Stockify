...
const Login = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-secondary-950 p-4 relative overflow-hidden">
            ...
            <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-primary-600/10 blur-[120px] rounded-full"></div>
            ...
            <div className="w-full max-w-md">
                <div className="mb-10 text-center">
                    ...
                    <p className="text-secondary-200 mt-2">Manage your supermarket efficiently</p>
                </div>
                ...
                <div className="dark-glass rounded-3xl p-8 shadow-2xl">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div>
                            <label className="block text-sm font-medium text-secondary-200 mb-2">Username</label>
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="block w-full pl-11 pr-4 py-3 bg-secondary-900/50 border border-secondary-700 text-white rounded-xl focus:ring-2 focus:ring-primary-500/50 focus:border-primary-500 transition-all outline-none"
